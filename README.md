    ...
    "plugins": [
      {
        ...
        "skipDisabledOptimiziation": false, // if set to true, disabled diagnostics are still processed so per-line or per-section overrides can be honored in patched tsc runs (default: false)
